...
public class EmailService {
        ...
        try {
            ...
            String html = """
                <div style="font-family: 'Georgia', serif; max-width: 480px; margin: 0 auto; padding: 2rem; background-color: #EED59F; border-radius: 16px;">
                    ...
                    <p style="color: #2c2c2c; line-height: 1.7;">
                        start by writing your first branch — an essay, article, diary entry, 
        ...
        try {
            ...
            String html = """
                <div style="font-family: 'Georgia', serif; max-width: 480px; margin: 0 auto; padding: 2rem; background-color: #EED59F; border-radius: 16px;">
                    ...
                    <p style="color: #2c2c2c; line-height: 1.7;">
                        your words are reaching people. keep writing! 🌿
                    </p>
    ...
    @Async
    public void sendCommentNotificationEmail(String toEmail, String ownerUsername,
                                          String commenterUsername, String articleTitle) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            helper.setFrom(fromEmail);
            helper.setTo(toEmail);
            helper.setSubject("someone commented on your branch on somessay. 🌿");
            ...
            String html = """
                <div style="font-family: 'Georgia', serif; max-width: 480px; margin: 0 auto; padding: 2rem; background-color: #EED59F; border-radius: 16px;">
                    ...
                    <p style="color: #2c2c2c; line-height: 1.7;">
                        <strong>@%s</strong> just commented on your branch:
                    </p>
            ...
            """.formatted(ownerUsername, commenterUsername, articleTitle);
